...
## 文章结构思路: [X 一个东西]
## Part 1 —— 什么是闪电 [下定义]
==**Lightning is a <font color='hotpink'>brilliant 程度</font> flash of light produced by <font color='Salmon'>an electrical discharge</font> from <font color='Salmon'>a storm cloud</font> `主旨`.**==
