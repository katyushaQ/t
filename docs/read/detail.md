...
**Water {++containing dissolved silica, calcium carbonate, or iron++}** ==may circulate== ^^through the enclosing sediment^^ and ==be deposited== ^^in cavities^^ ( such as marrow cavities and canals ) { in bone `地点`} { once occupied by blood vessels and nerves `条件`}. 
...
!!! faq ""
    ...
    C. { in the city `地点`} there ==are== **longer periods of dry weather** {++between episodes of rain++}
    > 在城市，雨季，干燥天气周期更长
...
!!! error ""
    ...
    **==延伸问题==**
    ...
    1.当只想修饰事的时候，即使后面有人，就用 for，来表达这个形容词与人无关，排除之
...
!!! faq ""   
    ...
    Paragraph 5 ==supports== **which of the following statements** about ^^cooperation among the people^^ { in the Mesa Verde area `地点`} { from the eleventh through the thirteenth century `时间`}?
    >  以下哪个陈述支持关于从11到13世纪MV地区人们之间的合作？

    !!! failure ""
        
        没明白，不是说 11-13 世纪之间的情况么？可是原文有 but 13 世纪发生了改变，那这个题既包含了13世纪之前也包含了13世纪那会的变化，那么A不是说的13世纪之前的情况么？
        
        **老师解答：原文是11-12世纪期间，不是到20世纪。**
    
    {--A--}. **Cooperation** ==allowed== ^^many households^^ ==to give up== ^^farming^^ and ==to specialize== ^^in making pottery and crafts^^.
    > 合作使得家庭放弃农业经营，并专门从事制造陶瓷和工艺。
    
    !!! failure ""
    
        没有提放弃农业经营
    
    {++B++}. **People** ==went== {++from exchanging food and crafts they individually produced to sharing { in a cooperative `地点`} effort to produce++} {++as much food as possible++}.
    > 人们把交换的食物和他们个人生产的工艺分享到合作性组织，然后努力去生产尽可能多的食物。
    
    !!! failure ""
        
        虽然这个地方没有11世纪的内容，但是是13世纪的主要内容
            
        但是我不明白，题干是一个时间区间11-13，而这里只有13的内容没有11，是否合适？
        
        **==2018-07-08复盘问题==**
        
        <font color='red'>昨天没看仔细就跳过去了，我比较不确定的这个选项的是， 题干 {++ from the eleventh through the thirteenth century++} 这是个闭区间吧（>=11 and <=13），这里提到了13世纪的内容，没有提到11也算真是么，我怕没有说全</font>
                
        <font color='blue'>上次那题是，提到了两项（金属和石头，但金属的描述是错误的，所以排除）</font>
        
        <font color='red'>结论就是：当选项内容出现大于1项的罗列时，选项间是与的关系，否则只有一个罗列项时，描述正确就是对，对么？</font>
        
        ----
        
        **老师解答：**
        
        选项描述了11-13，是按照时间顺序阐述的
    
    C. ^^Overtime there^^ ==was== **less cooperation** {++as farmers competed with each other++} { for trade with distant areas `目的`}.
     > 像农民为了与远方地区交易的互相竞争这样的少量合作是额外的。
     
     >> 当随着农民相互之间为了远距离的贸易竞争时，合作就减少了
    ...
    D. **Individuals** ==stopped cooperating== ^^with each other^^ { because they did not have enough food for themselves `原因`}.
    > 个体停止相互合作，是因为他们没有足够的食物养自己。

NEW WORDS |  NEW WORDS |  NEW WORDS
------------ | -------------  | -------------
cooperation 合作，协作 | In the face of sth. 面对某事物 | push 努力
residence 【正式】住宅 | scatter across 撒 | Archaeologist 考古学家
isolated 偏僻的 | pottery 陶瓷 | ceremonial 礼仪的，仪式的
opportunity for 机会，时机 | craft 【传统】工艺 | allow to 能做某事
contend 竞争 | patchy 局部地区的 | precipitation 【术语】降水
distant 遥远的 | ally 同盟国 | have difficulty with 感到困难
opposite 完全不同的 | diverse 各种各样的 | unpredictable 无法预测的
remain 依然 | farming 农场经营 | sb's effort to do sth. 努力
sensible 合理的 | as ... as possible 尽可能 | occasions 时刻，时候
persuade 说服 | reliably 可靠的 | era 时代
exchange 交换 | interested in 感兴趣的，关心的 | begin to do sth. 开始做某事